            ...
            // 2. User Merge Check (Takeout or Dine-In)
                ...
                try {
                    ...
                    if (activeRes.data && activeRes.data.length > 0) {
                        ...
                        const isPaymentStarted = activeOrder.paymentStatus === 'PAY_AT_COUNTER' || activeOrder.paymentStatus === 'PAID';
                        if (activeOrder.orderType === orderType.value && !isPaymentStarted) {
                            ...
                            console.log(`Skipping merge: Order Type mismatch or Payment Started (${activeOrder.paymentStatus})`);
                        }
                    }
                } catch (checkErr) {
