    ...
    <div class="lg:hidden fixed bottom-6 right-6 z-50">
        <Sheet>
            <SheetTrigger as-child>
                <Button size="icon" class="h-16 w-16 rounded-full shadow-2xl bg-primary text-primary-foreground hover:bg-primary/90 transition-all hover:scale-105 active:scale-95">
