  ...
  <div class="p-8 bg-gray-100 min-h-screen font-sans">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex items-center justify-between mb-12">
        <div>
          <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Admin Order Management</h1>
          <p class="mt-2 text-sm text-gray-500">Overview of current active orders</p>
        </div>
...
const statusVariant = (status) => {
  const variants = {
    'PENDING': 'secondary', // Yellow/Grayish
    'PAID': 'default',      // Blue (using default/primary)
    'PREPARING': 'secondary', // Purple-ish
    'COMPLETED': 'outline', // Green-ish (customized via class usually or stick to outline)
